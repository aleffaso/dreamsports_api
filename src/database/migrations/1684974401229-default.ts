...
export class Default1684974401229 implements MigrationInterface {
    name = 'Default1684974401229'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "customer_refresh_token" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "expiresIn" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "customerId" uuid, CONSTRAINT "PK_10d090f2e2118bd385c34b84b1b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_jwt_token" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "token" character varying NOT NULL, "refresh_token" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_9d4dcfde906ba17538fc4a403cb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "customer_refresh_token" ADD CONSTRAINT "FK_d225e2d1360f13bd9026898c3b9" FOREIGN KEY ("customerId") REFERENCES "customers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "customer_refresh_token" DROP CONSTRAINT "FK_d225e2d1360f13bd9026898c3b9"`);
        ...
        await queryRunner.query(`DROP TABLE "user_jwt_token"`);
        await queryRunner.query(`DROP TABLE "customer_refresh_token"`);
